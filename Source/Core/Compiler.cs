...
/// <summary>
/// Wraps basic SPIRV-Cross cross-compilation functionality provided by <see cref="NativeBindings.Compiler"/> into a type-safe and memory-safe object.
/// </summary>
public abstract unsafe class Compiler : Reflector
{
    ...
    internal NativeBindings.CompilerOptions* optionsPtr;

    internal Compiler(Context context, NativeBindings.Compiler* compiler) : base(context, compiler) 
    { 
        fixed (NativeBindings.CompilerOptions** optionsRef = &optionsPtr)
	...
	/// This is required to "support" separate image samplers in targets which do not NativeBindingsly support
