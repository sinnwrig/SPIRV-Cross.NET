...
using static NativeBindings.Resources;
using ResourceType = NativeBindings.ResourceType;
using BuiltinResourceType = NativeBindings.BuiltinResourceType;

/// <summary>
/// <para>Wraps SPIRV-Cross resource reflection functionality provided by <see cref="NativeBindings.Compiler"/> into a type-safe and memory-safe object.</para>
...
{
    private NativeBindings.Resources* _resources;
    internal NativeBindings.Resources* resources
    {
        get
        {
            Validate();
    ...
    private ReflectedBuiltinResource[] GetBuiltinResourceListForType(BuiltinResourceType type) 
    {
        ...
        for (int i = 0; i < resourceSpan.Length; i++)
        {
            NativeBindings.ReflectedBuiltinResource nativeResource = resourceListPtr[i];
    ...
    private static ReflectedResource ToManagedResource(NativeBindings.ReflectedResource resourcePtr)
    {
