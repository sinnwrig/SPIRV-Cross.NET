...
/// <summary>
/// Wraps SPIRV-Cross reflection functionality provided by <see cref="NativeBindings.Compiler"/> into a type-safe and memory-safe object.
/// </summary>
/// <remarks>
...
{
    private NativeBindings.Compiler* _compiler;
    internal NativeBindings.Compiler* compiler
    {
        get 
        {
            Validate();
    ...
    internal Reflector(Context context, NativeBindings.Compiler* compiler) : base(context)
    {
    ...
    internal Constant CreateConstant(Context context, ConstantID id, NativeBindings.Constant* constant)
    {
    ...
    internal Type CreateType(Context context, TypeID id, NativeBindings.Type* type)
    {
    ...
    {
        NativeBindings.EntryPoint* entryPointsPtr = null;
        ...
        for (int i = 0; i < (int)numEntryPoints; i++)
        {
            ...
            NativeBindings.EntryPoint nativeEntryPoint = entryPointsPtr[i];
    ...
    {
        NativeBindings.Set* setPtr = null;
    ...
    {
        NativeBindings.Resources* resourcePtr = null;
