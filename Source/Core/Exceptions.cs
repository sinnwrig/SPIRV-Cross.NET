...
/// <summary>
/// Represents an error that occurs when an internal SPIRV-Cross method returns a <see cref="NativeBindings.Result.InvalidSPIRV"/> 
/// </summary>
...
/// <summary>
/// Represents an error that occurs when an internal SPIRV-Cross method returns a <see cref="NativeBindings.Result.UnsupportedSPIRV"/> 
/// </summary>
...
/// <summary>
/// Represents an error that occurs when an internal SPIRV-Cross method returns a <see cref="NativeBindings.Result.InvalidArgument"/> 
/// </summary>
