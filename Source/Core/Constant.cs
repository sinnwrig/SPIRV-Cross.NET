...
using static NativeBindings.Constant;
...
{ 
    private NativeBindings.Constant* _constant;
    internal NativeBindings.Constant* constant
    {
        get
        {
            Validate();
    ...
    internal Constant(Context context, NativeBindings.Constant* constant) : base(context)
    {
